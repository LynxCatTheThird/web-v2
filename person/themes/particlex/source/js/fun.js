...
console.info("%c Debug %c %c ServiceWorker测试 %c fun.js 更新时间：2022年12月30日09点01分", "color:white; background-color:#4f90d9", "", "color:white; background-color:#4f90d9", "")
...
window.onkeydown = function (e) {
    ...
    console.warn("%c W06-7752 %c 打开了开发者模式，请遵循 AGPLv3 开源协议", "color:white; background-color:#e09d3ee09d3e", "");
};